...
.\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe -register:user -target:.\tools\NUnit.ConsoleRunner.3.2.1\tools\nunit3-console.exe -targetargs:".\BricksFx.Core.Test\bin\Release\BricksFx.Core.Test.dll .\BricksFx.DI.Ninject.Test\bin\Release\BricksFx.DI.Ninject.Test.dll" -filter:"+[*]* -[*.Test]*" 
