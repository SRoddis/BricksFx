...
.\tools\OpenCover.4.6.519\tools\OpenCover.Console.exe^
 ...
 -targetargs:"^
   .\BricksFx.Core\bin\Release\BricksFx.Core.dll^
   .\BricksFx.Core.Test\bin\Release\BricksFx.Core.Test.dll^
   .\BricksFx.DI.Ninject.Test\bin\Release\BricksFx.DI.Ninject.Test.dll"^
 -filter:"+[BricksFx.Core]* +[*]* -[*.Test]*" 
